...
struct OnboardingView: View {
    ...
    var body: some View {
        ...
        .compressoWindowMaterialBackground()
        .overlay(
            CompressoWindowDragArea()
                .frame(height: 52),
            alignment: .top
        )
    }
    ...
    private var welcomeContent: some View {
        VStack(alignment: .center, spacing: 16) {
            ...
            Label("Drag a supported file, trigger Quick Access, then drop it into Compresso.", systemImage: "sparkles.rectangle.stack")
                .foregroundColor(.secondary)
        }
